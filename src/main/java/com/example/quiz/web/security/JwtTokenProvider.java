...
import com.example.quiz.domain.exception.AccessDeniedException;
...
import com.example.quiz.servis.props.JwtPropertis;
...
public class JwtTokenProvider {
    ...
    private final JwtPropertis jwtProperties;
    ...
    public JwtRespons refreshUserTokens(
            final String refreshToken
    ) {
        JwtRespons jwtResponse = new JwtRespons();
